...
$company_name = $settings['company_name'] ?? 'SISTEMA TALLER';
$company_address = $settings['company_address'] ?? 'Av. Principal 123, Ciudad';
$company_phone = $settings['company_phone'] ?? '(555) 123-4567';
$print_footer_text = $settings['print_footer_text'] ?? 'Condiciones de Garantía: Este documento certifica la garantía del equipo descrito. La garantía cubre defectos de fábrica y mano de obra bajo condiciones normales de uso.';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Garantía <?php echo str_pad($warranty['id'], 4, '0', STR_PAD_LEFT); ?></title>
    <style>
        :root {
            --primary: #0f172a;
            --secondary: #64748b;
...
<body>
    ...
    <div class="page-container">
        ...
        <!-- Details -->
        <div class="section">
            <div class="section-header">DETALLES DE LA GARANTÍA</div>
                ...
                <div class="grid-2">
                    <div class="service-row">
                     ...
                     <div class="service-row">
                        ...
                        <div class="service-content"><?php echo ucfirst($warranty['status']); ?></div>
                    </div>
