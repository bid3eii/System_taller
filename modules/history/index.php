...
// If the user doesn't have view_all_entries permission, they only see their assigned orders
if (!$can_view_all) {
...
<div class="animate-enter">
    ...
    <div class="premium-filter-bar">
        ...
        <div class="search-input-wrapper">
            ...
            <input type="text" id="searchInput" class="premium-input"
        ...
        <div class="select-wrapper">
            <form id="filterFormStatus" method="GET" style="margin:0; width:100%;">
                <?php if (!empty($filterType)) {
                    echo '<input type="hidden" name="type" value="' . $filterType . '">';
                } ?>
        ...
        <div class="select-wrapper">
            <form id="filterFormType" method="GET" style="margin:0; width:100%;">
                <?php if (!empty($filterStatus)) {
                    echo '<input type="hidden" name="status" value="' . $filterStatus . '">';
                } ?>
    ...
    <div
        style="padding: 0 1rem 1rem 1rem; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
