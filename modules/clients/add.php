    ...
    if (empty($name)) {
        ...
        try {
            ...
            if ($stmt->execute([$name, $tax_id, $phone, $email, $address, get_local_datetime()])) {
                ...
                header("Location: index.php"); // Redirect for now
                exit;
            }
        ...
        <form method="POST" action="">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="tax_id" class="form-control" placeholder="Número de identificación">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="phone" class="form-control" placeholder="Ej. 5555-4444">
                ...
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <div class="input-group">
                        <input type="email" name="email" class="form-control" placeholder="cliente@ejemplo.com">
            ...
            <div style="display: flex; justify-content: flex-end; gap: 1rem; margin-top: 2rem;">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="ph ph-floppy-disk"></i> Guardar Cliente
                </button>
            </div>
        </form>
    </div>
